# Study-Efficiency-Analysis-Program
The goal of this project is to determine whether a student is using their study time efficiently by analyzing data such as hours studied, academic marks, and the study methods they use. The program then calculates a study efficiency score + provides targeted recommendations to help improve efficiency by suggesting more effective study methods.
